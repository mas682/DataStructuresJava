...
public class SetDemo2
{
	public static void main(String[] args) 
	{
     ...
     // SetInterface<String> aBag = new Set<String>(3);
      //testIsEmpty(aBag, true);
	  
	  String [] stringArray = {"A", "D", "B", "C", "A", "D", "", null};
	  SetInterface <String> aBag = null;
	  
	  //using the constructor that accepts an array
	  System.out.println("Adding the stringArray: ");
	  try{
	  aBag = new Set<String>(stringArray);
		displayBag(aBag);
	  }
	  ...
	  System.out.println("The test array has this many entries: " + test.length);
	  System.out.println((String)test[0] + (String)test[2] + (String)test[3]);
	  boolean remove = aBag.remove(null);
	System.out.println("Adding to the bag more strings than its initial capacity.");
      String[] contentsOfBag = {"A", "D", "E", "F", "C", "A", "G", ""};
   ...
   // Tests the method add.
	private static void testAdd(SetInterface<String> aBag, String[] content)
	{
   ...
   // Tests the two remove methods.
	private static void testRemove(SetInterface<String> aBag, String[] tests)
	{
   ...
   // correctResult indicates what isEmpty should return.   
	private static void testIsEmpty(SetInterface<String> aBag, boolean correctResult)
	{
   ...
   // Tests the method getFrequencyOf.
	//private static void testFrequency(SetInterface<String> aBag, String[] tests)
	//{
 //		System.out.println("\nTesting the method getFrequencyOf:");
   ...
   // Tests the method contains.
	private static void testContains(SetInterface<String> aBag, String[] tests)
	{
   ...
   // Tests the method toArray while displaying the bag.
	private static void displayBag(SetInterface<String> aBag)
	{
